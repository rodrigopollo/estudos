...
public class Tipo__String {
    public static void main(String[] args) {
       ...
       //  s = "Bom dia";
        ...
        System.out.println(s + "???"); // mesma coisa de maneira diferente, add !!! no final da string
        ...
        System.out.println(s.length());//Comando valido so em STRING, verifica qntidade de caracteres
