package fundamentos;
    ...
    public class C__NumberToString {
        public static void main(String[] args) {
            ...
            No exemplo 1 --> Voce tem a  num1 atribuida a classe wrapper Integer
            e usa o num1 pra transformar o valor da classe Integer no tipo String.

            No exemplo 2 --> Voce tem num2 do tipo primitivo INT e se voce quiser transformar
            o tipo primitivo em STRING voceprecisa primeiro fazer o seguinte:
            Primitivo INT -> Tipo Classe Wrapper Integer
            ...
            --> System.out.println(Integer.toString(num2).length());
            pode ser feita nao so com Integer (int) como com todos os outros Wrappers, byte, short, long, float e char
             */
