...
public class Area_CircTeste3 {
    public static void main(String[] args) {

// * NOTA: Area_Circ3 e Area_CircTeste3 sao a separacao entre MAIN,
// metodos e controres (sao 1 so)
//-----------------------------------------------------------------------------------------

        Area_Circ3 a1 = new Area_Circ3(10);
        Area_Circ3 a2 = new Area_Circ3(5);
        ...
        //              Area_Circ3.PI = 3.1415;

        System.out.println(a1.area());  // PI(11) * raio(10) * raio(10)
        System.out.println(a2.area());  // PI(22) * raio(5) * raio(5)
        System.out.println(Area_Circ3.PI); //So mostra o valor da constante PI


        // METODO --> acessando o metodo STATICO

        System.out.println(Area_Circ3.area(50));
...
--> a1.pi = 11 == Vc esta dizendo, eu quero que a1 (explicado na linha 41) acesse o atributo variavel
pi dentro da classe Area_Circ e altere o valor para 11.

            System.out.println(a1.area());
Metodo:     double area(){  <== É um metodo dentro de Area_Circ
                 return pi * raio * raio;
             }
...
que PI se torna constante, voce ainda pode ACESSAR e LER o valor de PI, vamos ver um exemplo:
    Exemplo:
      -->  System.out.println(Area_Circ.PI);    ...So mostra o valor da constante PI
             ...
             (Area_Circ.area(100));
 Metodo:     static double area(double raio){
                  return return PI * Math.pow((raio, 2))

 -->  (Area_Circ == Voce esta Acessando diretamente a Classe Area_Circ
 -->  .area == Depois de acessar a classe voce diz... quero usar AREA (no caso é um metodo)
 -->  (100) == O valor 100 eh o valor que vc esta atribuindo a variavel RAIO do tipo double que
 o metodo pede ......  static double area(double raio)
 */